    ...
    function AsideHeight() {
        ...
        $(window).resize(function() {
            if($(window).width() < 801) {
				...
				//$(".user-profile").load("Template/blocks/sidebar-user-profile.html");
				$(".menu-container").load("Template/blocks/menus/material-sidebar.html");
				...
				// ---------------------------------
					...
					$(".main-container").css('margin-top', containerMargin);
					$(".menu-container").load("Template/blocks/menus/dropdown.html");
					var sidebar_width = 0;
			    }
				...
				// ---------------------------------
					...
					$(".main-container").css('margin-top', containerMargin);
					$(".menu-container").load("Template/blocks/menus/megamenu.html");
					var sidebar_width = 0;
			    }
				...
				// ---------------------------------
					...
					//$(".user-profile").load("Template/blocks/sidebar-user-profile.html");
					$(".menu-container").load("Template/blocks/menus/iconic.html");
