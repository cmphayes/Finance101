...
jQuery(document).ready(function($) {
	...
	// 3. HTML blocks import
	//----------------------------------
    $(".apps-dropdown .dropdown-menu").load("Template/blocks/navbar/apps-dropdown.html");
    $(".notifications .dropdown-menu").load("Template/blocks/navbar/notifications-dropdown.html");
    //$(".user-dropdown .dropdown-menu").load("Template/blocks/navbar/user-dropdown.html");
    $("#right_sidebar").load("Template/blocks/rightbar/rightbar.html");
